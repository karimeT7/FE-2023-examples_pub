...
#phase = 'burnin' 
burnin_id = 'f028c132-6265-4626-83fa-27a80615c4e9'   # experiment id containing serialized population (required for pickup)
...
def build_demog():
    ...
    """
    # From input file csv #
    demog = Demographics.from_csv(input_file = os.path.join(manifest.input_dir,
                                                            "demographics","nodes.csv"), 
                                  id_ref="FE_EXAMPLE", init_prev = 0.01, include_biting_heterogeneity = True)
...
if __name__ == "__main__":
 ...
 #01ec14ee-724c-4b8b-829b-c13921018bfa
#suite id : 543240b0-51a8-4480-8131-feaea76e323f
